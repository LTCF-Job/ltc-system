...
export const mockVehicles: VehicleDTO[] = [
  { id: 'veh_1', plateNo: 'BZG-7915', displayName: '竹北一車', siteId: 'site_1', siteName: '竹北日照中心', region: 'hsinchu', brand: '中華', model: 'DE241LB8', manufactureYm: '2013-03', compulsoryInsuranceExpiry: '2025-12-23', passengerInsuranceExpiry: '2025-12-30', thirdPartyInsuranceExpiry: '2025-12-30', lastInspectionDate: '2024-12-23', wheelchairAccessible: true, active: true, createdAt: '2026-01-01' },
  { id: 'veh_2', plateNo: 'ABC-1234', displayName: '竹北二車', siteId: 'site_1', siteName: '竹北日照中心', region: 'hsinchu', brand: '中華', model: 'DE241L8', manufactureYm: '2012-03', compulsoryInsuranceExpiry: '2025-12-23', passengerInsuranceExpiry: '2025-12-30', thirdPartyInsuranceExpiry: '2025-12-30', lastInspectionDate: '2024-12-23', wheelchairAccessible: true, active: true, createdAt: '2026-01-01' },
  { id: 'veh_3', plateNo: 'DEF-5678', displayName: '竹南1車', siteId: 'site_2', siteName: '竹南日照單位', region: 'miaoli', brand: '中華', model: 'DE241L8', manufactureYm: '2012-05', compulsoryInsuranceExpiry: '2026-01-20', passengerInsuranceExpiry: '2026-01-20', thirdPartyInsuranceExpiry: '2026-01-20', lastInspectionDate: '2025-01-20', wheelchairAccessible: true, active: true, createdAt: '2026-01-01' },
  { id: 'veh_4', plateNo: 'GHI-9012', displayName: '竹南2車', siteId: 'site_2', siteName: '竹南日照單位', region: 'miaoli', brand: '中華', model: 'DE241L8', manufactureYm: '2011-11', compulsoryInsuranceExpiry: '2026-04-16', passengerInsuranceExpiry: '2026-04-18', thirdPartyInsuranceExpiry: '2026-04-18', lastInspectionDate: '2025-04-16', wheelchairAccessible: false, active: true, createdAt: '2026-01-01' },
  { id: 'veh_5', plateNo: 'JKL-3456', displayName: '竹東一車', siteId: 'site_3', siteName: '湖口長照單位', region: 'hsinchu', brand: '中華', model: 'DE241L8', manufactureYm: '2010-11', compulsoryInsuranceExpiry: '2026-05-27', passengerInsuranceExpiry: '2026-05-27', thirdPartyInsuranceExpiry: '2026-05-27', lastInspectionDate: '2025-05-27', wheelchairAccessible: true, active: false, createdAt: '2026-02-15' },
  { id: 'veh_6', plateNo: 'MNO-7890', displayName: '苗栗市1車', siteId: 'site_4', siteName: '苗栗市社區單位', region: 'miaoli', brand: '中華', model: 'DE241L8', manufactureYm: '2011-06', compulsoryInsuranceExpiry: '2025-06-04', passengerInsuranceExpiry: '2025-06-04', thirdPartyInsuranceExpiry: '2025-06-04', lastInspectionDate: '2025-06-04', wheelchairAccessible: false, active: true, createdAt: '2026-03-01' }
]
...
export const mockRoles: RoleDTO[] = [
  ...
  },
  {
    ...
    permissions: {
      ...
      masters_regions: { view: true, edit: false, delete: false },
      masters_cases: { view: true, edit: false, delete: false },
      masters_sites: { view: true, edit: false, delete: false },
      masters_vehicles: { view: true, edit: false, delete: false },
      masters_drivers: { view: true, edit: false, delete: false },
      driver_reports: { view: true, edit: false, delete: false },
      driver_report_mappings: { view: true, edit: false, delete: false },
      rides_calendar: { view: true, edit: false, delete: false },
      rides_issues: { view: true, edit: false, delete: false },
      rides_missing: { view: true, edit: false, delete: false },
      reports_trip_summary: { view: true, edit: false, delete: false },
      reports_hsinchu_schedule: { view: true, edit: false, delete: false },
      vehicles_maintenance: { view: true, edit: false, delete: false },
      attendance_fuel: { view: true, edit: false, delete: false },
      exports: { view: true, edit: false, delete: false },
      audit_logs: { view: true, edit: false, delete: false },
