      ...
      <el-tab-pane v-if="canViewDriverReports" label="批次上傳" name="upload">
        <div class="upload-stack">
          ...
          >
            ...
            <p class="drop-hint-sub">檔名建議包含車輛車次（例如「竹南2車 (回覆).xlsx」）</p>
          </el-upload>
          ...
          <section v-else class="file-panel">
            ...
            <el-table v-table-auto-width :data="rows" row-key="key" border class="file-table" style="width: 100%">
              ...
              <el-table-column label="車次" min-width="200" class-name="vehicle-col">
                <template #default="{ row }">
                  <el-select
                ...
                <template #default="{ row }">
                  <div class="detail-cell">
                    <div class="detail-summary-line">
                      ...
                      <span v-else-if="row.status === 'needsVehicle'" class="text-warning">請先選擇對應車次</span>
    ...
    >
      <div v-if="selectedRowForDetail" class="detail-dialog-content">
        <div class="file-info-bar">
          ...
          <div class="info-row">
            <div class="info-item">
              <span class="info-label">對應車次：</span>
