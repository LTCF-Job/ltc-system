...
ON CONFLICT (id) DO UPDATE SET
  ...
  remarks = EXCLUDED.remarks, site_id = EXCLUDED.site_id, site_name_raw = EXCLUDED.site_name_raw;

-- ============================================================
-- 6. 個案排班設定 (case_schedules) — C-0008 刻意不建排班，示範待排班個案
-- ============================================================
INSERT INTO case_schedules (id, case_id, effective_range, weekdays, trip_pattern, unit_price, distance_km, service_duration_min, service_code) VALUES
('41000000-0000-4000-8000-000000000001', '40000000-0000-4000-8000-000000000001', '[2025-01-01,)', '{1,2,3,4,5}', 4, 115.00, 8.50, 15, 'BD03'),
('41000000-0000-4000-8000-000000000002', '40000000-0000-4000-8000-000000000002', '[2025-01-01,)', '{1,3,5}', 2, 115.00, 6.20, 10, 'BD03'),
('41000000-0000-4000-8000-000000000003', '40000000-0000-4000-8000-000000000003', '[2025-01-01,)', '{2,4}', 2, 115.00, 5.00, 10, 'BD03'),
('41000000-0000-4000-8000-000000000004', '40000000-0000-4000-8000-000000000004', '[2025-01-01,)', '{1,2,3,4,5}', 4, 115.00, 7.30, 15, 'BD03'),
('41000000-0000-4000-8000-000000000005', '40000000-0000-4000-8000-000000000005', '[2025-01-01,2026-06-30)', '{1,3,5}', 2, 115.00, 4.80, 10, 'BD03'),
('41000000-0000-4000-8000-000000000006', '40000000-0000-4000-8000-000000000006', '[2025-06-01,)', '{1,2,3,4,5}', 1, 115.00, 3.90, 10, 'BD03'),
('41000000-0000-4000-8000-000000000007', '40000000-0000-4000-8000-000000000007', '[2025-01-01,)', '{2,4}', 4, 115.00, 9.10, 15, 'BD03')
ON CONFLICT (id) DO UPDATE SET
  case_id = EXCLUDED.case_id, effective_range = EXCLUDED.effective_range,
...
-- ============================================================
INSERT INTO case_transport_preferences (case_id, outbound_vehicle_id, inbound_vehicle_id) VALUES
('40000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000001'),
('40000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002', '20000000-0000-4000-8000-000000000002'),
('40000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000003', '20000000-0000-4000-8000-000000000003'),
('40000000-0000-4000-8000-000000000004', '20000000-0000-4000-8000-000000000003', NULL),
('40000000-0000-4000-8000-000000000005', '20000000-0000-4000-8000-000000000005', '20000000-0000-4000-8000-000000000005'),
('40000000-0000-4000-8000-000000000007', '20000000-0000-4000-8000-000000000001', '20000000-0000-4000-8000-000000000002')
...
-- 9. 照護人員 (caregivers)
-- ============================================================
INSERT INTO caregivers (id, site_name, name, type, contact) VALUES
('50000000-0000-4000-8000-000000000001', '新竹縣站', '周雅婷', 'case_manager', '03-1234567'),
('50000000-0000-4000-8000-000000000002', '苗栗縣站', '謝文彬', 'specialist', '037-123456'),
('50000000-0000-4000-8000-000000000003', '舊竹南站', '洪淑貞', 'case_manager', '037-654321')
ON CONFLICT (id) DO UPDATE SET
  site_name = EXCLUDED.site_name, name = EXCLUDED.name,
