...
('20000000-0000-4000-8000-000000000001', 'AAA-1688', '新竹一號車', 'active', '10000000-0000-4000-8000-000000000001', '豐田', 'Hiace', '2021-05', '2027-05-01', '2027-05-01', '2027-05-01', '2026-03-15', true, true, true, true, false),
('20000000-0000-4000-8000-000000000002', 'AAB-2288', '新竹二號車', 'active', '10000000-0000-4000-8000-000000000001', '福特', 'Transit', '2020-09', '2027-02-01', '2027-02-01', '2027-02-01', '2026-02-20', false, true, true, false, false),
('20000000-0000-4000-8000-000000000003', 'ABC-3399', '苗栗一號車', 'active', '10000000-0000-4000-8000-000000000002', '豐田', 'Hiace', '2022-03', '2027-08-01', '2027-08-01', '2027-08-01', '2026-04-10', true, true, false, true, false),
('20000000-0000-4000-8000-000000000004', 'ABD-4410', '苗栗二號車', 'maintenance', '10000000-0000-4000-8000-000000000002', '日產', 'NV350', '2019-11', '2026-11-01', '2026-11-01', '2026-11-01', '2025-12-01', false, true, false, false, false),
('20000000-0000-4000-8000-000000000005', 'ABE-5521', '竹市一號車', 'active', '10000000-0000-4000-8000-000000000003', '豐田', 'Hiace', '2023-01', '2028-01-01', '2028-01-01', '2028-01-01', '2026-06-01', true, true, true, true, true),
...
('40000000-0000-4000-8000-000000000001', '王秀琴', '王秀琴', convert_to('demo-cipher-C-0001','UTF8'), convert_to('demo-hmac-C-0001','UTF8'), 'A12***0001', '新竹縣竹北市文興路一段1號', 'CMS 2', 1, 2, NULL, 'active', '一般戶', 'F', '1948-03-12', '女兒', '王小美', '新竹縣竹北市文興路一段1號', NULL),
('40000000-0000-4000-8000-000000000002', '李國華', '李國華', convert_to('demo-cipher-C-0002','UTF8'), convert_to('demo-hmac-C-0002','UTF8'), 'A22***0002', '新竹縣竹北市中正西路20號', 'CMS 4', 2, 1, NULL, 'active', '中低收入戶', 'M', '1955-07-22', '兒子', '李文彬', '新竹縣竹北市中正西路20號', NULL),
('40000000-0000-4000-8000-000000000003', '張阿蘭', '張阿蘭', convert_to('demo-cipher-C-0003','UTF8'), convert_to('demo-hmac-C-0003','UTF8'), 'A32***0003', '苗栗縣苗栗市中山路30號', 'CMS 3', 1, 3, NULL, 'active', '一般戶', 'F', '1950-11-05', '媳婦', '張林月', '苗栗縣苗栗市中山路30號', NULL),
('40000000-0000-4000-8000-000000000004', '陳福來', '陳福來', convert_to('demo-cipher-C-0004','UTF8'), convert_to('demo-hmac-C-0004','UTF8'), 'A42***0004', '苗栗縣頭份市中央路40號', 'CMS 3', 1, 2, NULL, 'suspended', '一般戶', 'M', '1952-02-18', '女兒', '陳小玉', '苗栗縣頭份市中央路40號', '暫停服務：住院治療中'),
('40000000-0000-4000-8000-000000000005', '劉月娥', '劉月娥', convert_to('demo-cipher-C-0005','UTF8'), convert_to('demo-hmac-C-0005','UTF8'), 'A52***0005', '新竹市東區中央路50號', 'CMS 2', 2, 4, '2026-06-30', 'closed', '一般戶', 'F', '1945-09-30', '配偶', '劉大山', '新竹市東區中央路50號', '個案已轉住機構，結案'),
('40000000-0000-4000-8000-000000000006', '許進財', '許進財', convert_to('demo-cipher-C-0006','UTF8'), convert_to('demo-hmac-C-0006','UTF8'), 'A62***0006', '新竹市北區中山路60號', NULL, NULL, NULL, NULL, 'active', '一般戶', 'M', '1958-12-01', '女兒', '許小芬', '新竹市北區中山路60號', '服務類別待社工評估後補齊'),
('40000000-0000-4000-8000-000000000007', '楊淑惠', '楊淑惠', convert_to('demo-cipher-C-0007','UTF8'), convert_to('demo-hmac-C-0007','UTF8'), 'A72***0007', '新竹縣竹北市光明一路70號', 'CMS 4', 1, 1, NULL, 'active', '一般戶', 'F', '1949-04-25', '兒子', '楊文宏', '新竹縣竹北市光明一路70號', NULL),
('40000000-0000-4000-8000-000000000008', '蔡明宗', '蔡明宗', NULL, NULL, NULL, '苗栗縣竹南鎮中正路80號', NULL, 2, 2, NULL, 'active', '一般戶', 'M', '1960-08-14', '配偶', '蔡林秀', NULL, '新申請個案，尚未排班')
ON CONFLICT (id) DO UPDATE SET
  name = EXCLUDED.name, name_normalized = EXCLUDED.name_normalized,
  national_id_cipher = EXCLUDED.national_id_cipher, national_id_hmac = EXCLUDED.national_id_hmac,
